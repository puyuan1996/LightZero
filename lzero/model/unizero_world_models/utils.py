...
class LossWithIntermediateLosses:
    ...
    def __init__(
        ...
        self.latent_norm_reg_loss_weight = latent_norm_reg_loss_weight
        ...
        for k, v in kwargs.items():
            ...
            elif k == 'latent_norm_reg_loss':
                self.loss_total += self.latent_norm_reg_loss_weight * v
