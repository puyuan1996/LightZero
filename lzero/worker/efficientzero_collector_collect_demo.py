...
from lzero.mcts.tree_search.game_collect_demo import GameHistory
from lzero.mcts.utils import prepare_observation_list


@SERIAL_COLLECTOR_REGISTRY.register('episode_efficientzero_collect_demo')
class EfficientZeroCollectDemoCollector(ISerialCollector):
    """
    Overview:
            ...
            for env_id, timestep in timesteps.items():
                with self._timer:
                    ...
                    if two_player_game:
                        ...
                        game_histories[env_id].append(actions[env_id], leaf_nodes[env_id], leaf_hidden_states[env_id],
                                                      search_paths[env_id], to_ndarray(obs['observation']), clip_reward)
