...
from lzero.mcts.buffer.game_block_collect_demo import GameBlock
from lzero.mcts.utils import prepare_observation_list


@SERIAL_COLLECTOR_REGISTRY.register('episode_muzero_collect_demo')
class MuZeroCollectorCollectDemo(ISerialCollector):
    """
    Overview:
    ...
    def collect(self,
        ...
        while True:
            with self._timer:
                ...
                if not self.game_config.mcts_ctree:
            ...
            for env_id, timestep in timesteps.items():
                with self._timer:
                    ...
                    print(f'total_transitions: {total_transitions}, reward: {reward}, done: {done}')
                    ...
                    if self.game_config.mcts_ctree:
                        ...
                        # collect_demo related
                        game_blocks[env_id].append(actions[env_id], leaf_nodes[env_id], leaf_hidden_states[env_id],
                                                   search_paths[env_id], to_ndarray(obs['observation']), reward)
