...
from lzero.mcts.ctree.ctree_stochastic_muzero import stochastic_mz_tree as tree_muzero
if TYPE_CHECKING:
    ...
    from lzero.mcts.ctree.ctree_stochastic_muzero import stochastic_mz_tree as stochastic_mz_tree
