...
namespace tree
{
    ...
    {
    public:
        int visit_count, to_play, latent_state_index_in_search_path, latent_state_index_in_batch, is_reset, action_space_size;
        // sampled related core code
        CAction best_action;
        ...
        void expand(int to_play, int latent_state_index_in_search_path, int latent_state_index_in_batch, float value_prefix, const std::vector<float> &policy_logits);
