...
cdef extern from "lib/cnode.h" namespace "tree":
    cdef cppclass CNode:
        ...
        void expand(int to_play, int latent_state_index_in_search_path, int latent_state_index_in_batch, float value_prefixs,
    ...
    void cbatch_backpropagate(int latent_state_index_in_search_path, float discount_factor, vector[float] value_prefixs,
