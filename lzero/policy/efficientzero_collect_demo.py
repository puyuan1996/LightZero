...
from lzero.mcts import EfficientZeroCollectDemoMCTSPtree as MCTS_ptree
...
@POLICY_REGISTRY.register('efficientzero_collect_demo')
class EfficientZeroCollectDemoPolicy(Policy):
    """
    Overview:
    ...
    def _forward_collect(
        ...
        with torch.no_grad():
            ...
            for i, env_id in enumerate(ready_env_id):
                ...
                # ==============================================================
                # collect_demo related code
                # NOTE: collect the pre-trained agent data, we use deterministic action.
                # ==============================================================
