...
def train_muzero(
    ...
    assert create_cfg.policy.type in ['efficientzero', 'muzero', 'sampled_efficientzero', 'stochastic_muzero'], \
        "train_muzero entry now only support the following algo.: 'efficientzero', 'muzero', 'sampled_efficientzero','stochastic_muzero"
