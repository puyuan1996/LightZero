...
def collect_muzero(
    ...
    assert create_cfg.policy.type in ['efficientzero', 'efficientzero_collect_demo', 'muzero', 'sampled_efficientzero'], \
    ...
    elif create_cfg.policy.type in ['efficientzero', 'efficientzero_collect_demo']:
    ...
    while True:
        ...
        print(f'collect_demo_data done! save into {data_path}.')
        break