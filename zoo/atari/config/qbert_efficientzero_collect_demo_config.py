...
qbert_efficientzero_config = dict(
    ...
    policy=dict(
        ...
        model_path='/Users/puyuan/code/LightZero/zoo/atari/config/data_ez_ctree/qbert_efficientzero_ns50_upc1000_ic1_seed0/ckpt/iteration_0.pth.tar',
        env_name='QbertNoFrameskip-v4',
...
qbert_efficientzero_create_config = dict(
    ...
    collector=dict(
        ...
        import_names=['lzero.worker.efficientzero_collector_collect_demo'],
    )
)
...
if __name__ == "__main__":
    ...
    serial_pipeline_efficientzero_collect_demo([main_config, create_config], seed=0, max_env_step=max_env_step)
